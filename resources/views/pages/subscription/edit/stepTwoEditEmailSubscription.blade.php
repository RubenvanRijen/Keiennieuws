    ...
    <div class="container">
        <form id="start-subscription" action="{{ url('/subscription/editsteptwoemail') }}" method="POST">
            ...
            <div class="custom-input">
                ...
                <input type="email" class="form-control @error('confirmation_email') is-invalid @enderror" required value="{{old('confirmation_email')?? $user->email ?? ''}}" name="confirmation_email" class="form-control" id="confirmation_email" aria-describedby="email">
            ...
            <div class="custom-input">
                ...
                <input type="email" class="form-control @error('email') is-invalid @enderror" required value="{{old('email')  ?? ''}}" name="email" class="form-control" id="email" aria-describedby="email">
                @error('email')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
